           ...
           IF ((i_ .GT. 0) .AND. .NOT. (i .EQ. j)) THEN
             IF (f(i_,2) .le. 1.D0) THEN
               ...
               IF (help2 .LE. 0.D0) THEN
                 IF (dwrit .EQ. 2) THEN
C                   Write(logfile,*) "thirds > 0,help2 <= 0"
                 END IF
                 GOTO 60
               END IF
               IF (help2 .LT. helplower) THEN
                 IF (dwrit .EQ. 2) THEN
C                   Write(logfile,*) "helplower = ",help2
                 END IF
                 helplower = help2
               END IF
         	   END IF
...
C                   Write(logfile,*) "thirds < 0,help2 <= 0"
               ...
               IF (help2 .GT. helpgreater) THEN
                 IF (dwrit .EQ. 2) THEN
C                   Write(logfile,*) "helpgreater = ",help2
                 END IF
                 helpgreater = help2
               END IF
             END IF
...
31       CONTINUE
     ...
     +        (fmin - eps*abs(fmin))) THEN
              IF (dwrit .EQ. 2) THEN
C                Write(logfile,*) "> fmin - eps|fmin|"
              END IF
              GOTO 60
            END IF
         ELSE
C           IF (dwrit .EQ. 2) THEN
C           Write(logfile,*) "helpgreater > helplower",helpgreater,
C     +            helplower,helpgreater - helplower
C           END IF
           GOTO 60
         END IF
         GOTO 40
