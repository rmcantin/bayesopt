...
namespace bayesopt
{
  ...
  ///////////////////////////////////////////////////////////////////////////
  BayesianRegressor::BayesianRegressor(size_t dim, bopt_params parameters):
    dim_(dim), mMean(dim, parameters){}

  BayesianRegressor::~BayesianRegressor(){}


  BayesianRegressor* BayesianRegressor::create(size_t dim, 
					       bopt_params parameters)
  {
    BayesianRegressor* s_ptr;
